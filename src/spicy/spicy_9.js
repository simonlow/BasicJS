...
//console.log(repeat(function(a) {return 2*a}, 3, [2,2,2]));
...
console.log(someEven([1,5,2,0,3], x => x === 1));
*/
...
export const filter = (arr, test) => {
    let passed = arr.filter(elem => test(elem));
    let failed = arr.filter(elem => !test(elem));
    return {fail: failed, pass: passed};
};
...
//console.log(anEvenIsOdd([1,2,2,2,2]));
//console.log(anEvenisOdd([2,1,2,1,2]));
...
export const hasExactly = (arr, test, n) => {
    let filtered = arr.filter ( x => test(x));
...
//console.log(hasExactly([1,2,3,1,1], x => x === 1, 3));
//console.log(hasExactly([1,2,3,1,2], x => x === 1, 3));